...
## Project Structure
    ...
    ├── testapiautosetting_125701  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125701`
...
2. Clone this repo and `cd testapiautosetting_125701`
